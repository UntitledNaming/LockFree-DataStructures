...
public:
	LFQueue()
	{
		...
		if (InterlockedIncrement64((long long*)&m_refCnt) == 1)
		{
	...
	~LFQueue()
	{
		if (InterlockedDecrement64((long long*)&m_refCnt) == 0)
		{
	...
	bool Dequeue(T& OutputParam)
	{
		...
		while (1)
		{
			...
			temp = localHeadNext->_data;
			localHeadNext = (Node*)((UINT64)localHeadNext | (retCntHead << 47));
